...
/**
 * Docs generated by Arash A. using GitHub copilot:
 * {@link TypeTuple} represents a node within a {@link TypeLattice} structure. It encapsulates a type (a
 * {@link TTRRecordType}) and maintains a type increment (incrementSoFar) that accumulates changes as the lattice is
 * traversed or constructed.
 */
public class TypeTuple {
	...
	public TypeTuple(TTRRecordType t, long id) {
		super();  // AA is this doing anything here? Because parent class is just Object!
		this.type = t;
		this.id = id;
	}
